...
// Recoverable error boundary for the root segment. Per Next.js App
// Router conventions, this wraps everything below the root layout.
// Fatal errors (where even the root layout couldn't render) fall
  ...
  return (
    <div className="mx-auto max-w-xl px-6 py-20 text-center">
      ...
      <p className="mt-3 text-sm text-ink-500">
        The page couldn&rsquo;t finish loading. Try again, or contact
