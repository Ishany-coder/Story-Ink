      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-3 sm:flex-row sm:items-center sm:gap-6">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:ml-auto">
          <button
            ...
            className="rounded-full border border-cream-300 px-4 py-2 text-xs font-medium text-ink-700 transition-colors hover:bg-cream-200"
          >
            Reject
          </button>
          <button
            ...
            className="rounded-full bg-moss-700 px-4 py-2 text-xs font-semibold text-cream-50 shadow-sm transition-colors hover:bg-moss-900"
          >
            Accept
          </button>
        </div>
